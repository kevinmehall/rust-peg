 ...
 -> RuleResult<bool> {
    {
                ...
                let seq_res =
                    {
                        ...
                        match choice_res {
                            ...
                            Failed => slice_eq(input, state, pos, "#[pub]"),
                        }
                    };
                match seq_res {
                    Matched(pos, _) => {
                        {
                            let seq_res = parse___(input, state, pos);
                            match seq_res {
                                Matched(pos, _) => { Matched(pos, { true }) }
                                Failed => Failed,
                            }
                        }
                    }
        ...
        match choice_res {
            ...
            Failed => {
                ...
                match seq_res {
                    Matched(pos, _) => { Matched(pos, { false }) }
                    Failed => Failed,
                }
            }
        }
                    ...
                    Matched(pos, _) => {
                        {
                            let seq_res =
                                {
                                    let str_start = pos;
                                    match parse_rust_type(input, state, pos) {
                                        Matched(newpos, _) => {
                                            Matched(newpos,
                                                    &input[str_start..newpos])
                                        }
                                        Failed => Failed,
                                    }
                                };
...
fn parse_rust_path<'input>(input: &'input str, state: &mut ParseState<'input>,
                           pos: usize) -> RuleResult<String> {
    {
        ...
        match seq_res {
            Matched(pos, p) => { Matched(pos, { p.to_string() }) }
            Failed => Failed,
        }
    }
}
                ...
                let seq_res =
                    {
                        ...
                        loop  {
                            let pos = repeat_pos;
                            let step_res = parse_labeled(input, state, pos);
                            match step_res {
                                Matched(newpos, value) => {
                                    repeat_pos = newpos;
                                    repeat_value.push(value);
                ...
                let seq_res =
                    {
                        ...
                        loop  {
                            let pos = repeat_pos;
                            let step_res = parse_prefixed(input, state, pos);
                            match step_res {
                                Matched(newpos, value) => {
                                    repeat_pos = newpos;
                                    repeat_value.push(value);
        ...
        let choice_res =
            {
                ...
                match seq_res {
                    Matched(pos, _) => {
                        {
                            let seq_res = parse_suffixed(input, state, pos);
                            match seq_res {
                                Matched(pos, expression) => {
                                    Matched(pos,
                                            {
            ...
            Failed => {
                ...
                match choice_res {
                    ...
                    Failed => {
                        let choice_res =
                            {
                                let seq_res = parse_not(input, state, pos);
                                match seq_res {
                                    Matched(pos, _) => {
                                        {
                                            let seq_res =
        ...
        let choice_res =
            {
                ...
                match seq_res {
                    Matched(pos, expression) => {
                        {
                            let seq_res = parse_question(input, state, pos);
                            match seq_res {
                                Matched(pos, _) => {
                                    Matched(pos,
                                            {
...
fn parse_literal<'input>(input: &'input str, state: &mut ParseState<'input>,
                         pos: usize) -> RuleResult<Expr> {
    {
        let seq_res =
            {
                let choice_res = parse_doubleQuotedString(input, state, pos);
                match choice_res {
                    Matched(pos, value) => Matched(pos, value),
            ...
            Matched(pos, string) => {
                {
                    let seq_res = parse___(input, state, pos);
                    match seq_res {
                        Matched(pos, _) => { Matched(pos, { string }) }
                        Failed => Failed,
                    }
                }
            }
                    ...
                    let seq_res =
                        {
                            ...
                            loop  {
                                let pos = repeat_pos;
                                let step_res =
                                    parse_doubleQuotedCharacter(input, state,
                                                                pos);
                                match step_res {
                                    Matched(newpos, value) => {
                                        repeat_pos = newpos;
            ...
            Matched(pos, _) => {
                {
                    ...
                    match seq_res {
                        Matched(pos, c) => {
                            Matched(pos, { c.chars().next().unwrap() })
                        }
                        Failed => Failed,
                    }
                }
                    ...
                    let seq_res =
                        {
                            ...
                            loop  {
                                let pos = repeat_pos;
                                let step_res =
                                    parse_singleQuotedCharacter(input, state,
                                                                pos);
                                match step_res {
                                    Matched(newpos, value) => {
                                        repeat_pos = newpos;
            ...
            Matched(pos, _) => {
                {
                    let seq_res =
                        {
                            let assert_res = parse_digit(input, state, pos);
                            match assert_res {
                                Failed => Matched(pos, ()),
                                Matched(..) => Failed,
                            }
                    ...
                    match seq_res {
                        Matched(pos, _) => { Matched(pos, { 0u8 as char }) }
                        Failed => Failed,
                    }
                }
            }
            ...
            Matched(pos, _) => {
                {
                    ...
                    match seq_res {
                        Matched(pos, value) => {
                            Matched(pos,
                                    {
                                        char::from_u32(u32::from_str_radix(value,
                                                                           16).unwrap()).unwrap()
                                    })
                        }
                        Failed => Failed,
